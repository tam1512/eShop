...
<body>
                  ...
                  <form class="row g-3" method="post">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="email" name="email" class="form-control<?php echo e(!empty($errors['email']) ? ' error_input' : false); ?>" id="yourEmail" value="<?php echo e(!empty($old['email']) ? $old['email'] : false); ?>">
                        <?php echo !empty($errors['email']) ? '<div class="error">'.$errors['email'].'</div>' : false; ?>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="password" class="form-control<?php echo e(!empty($errors['email']) ? ' error_input' : false); ?>" id="yourPassword">
                      <?php echo !empty($errors['password']) ? '<div class="error">'.$errors['password'].'</div>' : false; ?>
                    ...
                    <!-- <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="<?php echo e(_WEB_HOST_ROOT); ?>/admin/auth/register">Create an account</a></p>
                    </div> -->
                  </form>
  ...
  <script src="<?php echo e(_WEB_HOST_ROOT_ADMIN); ?>/assets/js/jquery.min.js"></script>
  <script src="<?php echo e(_WEB_HOST_ROOT_ADMIN); ?>/assets/js/main.js"></script>
  <script src="<?php echo e(_WEB_HOST_ROOT_ADMIN); ?>/assets/js/custom.js"></script>

</body>

</html><?php /**PATH E:\program File\xampp\htdocs\eshop\src\views/admin/modules/auth/login.blade.php ENDPATH**/ ?>