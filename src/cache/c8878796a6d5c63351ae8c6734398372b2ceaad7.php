...
<body class="js">
   ...
   <?php echo $__env->make('client.blocks.homeHeader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	
	<?php echo $__env->yieldContent('heroSlider'); ?>
	<?php echo $__env->yieldContent('smallBanner'); ?>
	<?php echo $__env->yieldContent('productArea'); ?>
	<?php echo $__env->yieldContent('midiumBanner'); ?>
	<?php echo $__env->yieldContent('mostPopular'); ?>
	<?php echo $__env->yieldContent('cownDown'); ?>
	<?php echo $__env->yieldContent('shopBlog'); ?>
	<?php echo $__env->yieldContent('shopServices'); ?>
	<?php echo $__env->yieldContent('shopNewsletter'); ?>
...
</html><?php /**PATH E:\program File\xampp\htdocs\eshop\src\views/client/layouts/home.blade.php ENDPATH**/ ?>