  ...
  <main>
    <div class="container">
      ...
      <section class="section error-404 min-vh-100 d-flex flex-column align-items-center justify-content-center">
        ...
        <h2>File: <?php echo e($exception->getFile()); ?></h2>
        <h2>Line: <?php echo e($exception->getLine()); ?></h2>
        <a class="btn" href="<?php echo e(_WEB_HOST_ROOT); ?>/admin">Back to home</a>
        <img src="<?php echo e(_WEB_HOST_ROOT_ADMIN); ?>/assets/img/not-found.svg" class="img-fluid py-5" alt="Page Not Found">
        <div class="credits">
...
</html><?php /**PATH E:\program File\xampp\htdocs\eshop\src\views/admin/modules/errors/error.blade.php ENDPATH**/ ?>