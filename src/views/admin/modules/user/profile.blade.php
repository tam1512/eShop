            ...
            <div class="tab-content pt-2">
               ...
               <form>
                  <div class="row mb-3">
                     ...
                     <img src="{{$user['avatar'] ?? _WEB_HOST_ROOT_ADMIN.'/assets/img/no-avatar.png'}}" alt="Profile">
                     <div class="pt-2">
                  ...
                  <div class="row mb-3">
                     ...
                     <div class="col-md-8 col-lg-9">
                     <textarea name="about" class="form-control" id="about" style="height: 100px">{{$user['description']}}</textarea>
                     </div>
                  </div>
                  ...
                  <div class="row mb-3">
                     ...
                     <div class="col-md-8 col-lg-9">
                     <input name="phone" type="text" class="form-control" id="Phone" value="{{$user['telephone']}}">
                     </div>
                  </div>
